                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="kelas" name="kelas" style="font-weight: bold;"disabled>
                           <option>-- Pilih --</option>
                        <?php
                  ...
                  <select class="form-control" id="jurusan" name="jurusan"style="font-weight: bold;"disabled>
                  <option>-- Pilih --</option>
                  <?php
