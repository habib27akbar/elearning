          ...
          <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
            ...
            <li class="nav-item" style="width: 400px;">
              <a href="#" style="color: #fff;text-decoration: none;">
               ...
               <b style="font-size : 22px">Sekolah SMK Link And Match</b></a>
             </li>
           </ul>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile">
            <div class="nav-link">
              <div class="profile-image"> <img src="../vendor/images/Logo-Cover.png" alt="image" style="width: 100%;" />
...
<!-- 
  ...
  <div class="container-fluid clearfix">
    <span class="text-info d-block text-center text-sm-left d-sm-inline-block">copyright@ 2024</span>
    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Sekolah SMK Link And Match <i class="fa fa-graduation-cap text-danger"></i></span>
  </div>
  </footer>
  <!-- partial -->
</div>
