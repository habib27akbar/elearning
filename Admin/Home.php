      ...
      <div class="col-md-9">
        <div class="card">
          <div class="card-body">
            ...
            <?php
            $faces = mysqli_query($con, "SELECT ta.nama_lengkap, tfi.face_image, ts.nama_siswa, tg.nama_guru, tfi.created_at FROM `tb_face_images` tfi
            ...
            <table class="table table-condensed table-striped table-hover" id="data">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><img src="<?= getImageFromBlob($f['face_image']); ?>" class="img-face" style="width:60px;height:60px;"></td>
                    <td><?= $user ?></td>
                    <td><?= $f['created_at'] ?></td>
                  </tr>
                <?php } ?>
